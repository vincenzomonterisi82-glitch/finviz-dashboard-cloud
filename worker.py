...
DB_PATH=os.getenv('DB_PATH','finviz.db'); TTL=int(os.getenv('CACHE_TTL_SECONDS','3600')); MAX_PAGES=int(os.getenv('MAX_PAGES','30')); FILTERS=os.getenv('FINVIZ_FILTERS','cap_midover,geo_usa,sh_avgvol_o1000,sh_opt_option,sh_price_o30')
def db():
